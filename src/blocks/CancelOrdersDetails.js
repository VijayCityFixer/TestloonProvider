...
export default class CancelOrdersDetails extends Component {
      ...
      Data: [
        {
          ...
          tokenamount :'$ 5000',
          cancelamount :'Refunded to Testloon',
          guest:'5 Guests',
              ...
              renderItem={(item)=>{
                return(
                  ...
                  >
                    ...
                    <Text style={{fontSize:RFValue(13),color:KellyGreen}}>{item.item?.cancelamount}</Text>
                    </View>
